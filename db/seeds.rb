...
Movie.create!([
  {title: "Plane", rating: "PG-13", total_gross: 3057.298, description: "After a heroic job of successfully landing his storm-damaged aircraft in a war zone, a fearless pilot finds himself between the agendas of multiple militias planning to take the plane and its passengers hostage.", released_on: 2023-01-12, director: "Plane", duration: "120", image_file_name: "placeholder.png"},
  {title: "Puss in Boots: The Last Wish", rating: "PG-13", total_gross: 2910.358, description: "Puss in Boots discovers that his passion for adventure has taken its toll: He has burned through eight of his nine lives, leaving him with only one life left. Puss sets out on an epic journey to find the mythical Last Wish and restore his nine lives.", released_on: 2023-01-01, director: "Bruce Wayne", duration: "120", image_file_name: "placeholder.png"},
  {title: "TÁR", rating: "PG-13", total_gross: 101.409, description: "Renowned musician Lydia Tár is days away from recording the symphony that will elevate her career.  However, Lydia's elaborate facade begins to unravel, revealing dirty secrets and the corrosive nature of power.", released_on: "2022-09-23", director: "Bruce Wayne", duration: "120", image_file_name: "placeholder.png"},
  {title: "Marlowe", rating: "PG-13", total_gross: 31.433, description: "As poor business and loneliness tolls on private detective Philip Marlowe, a beautiful blonde arrives and asks him to find her ex-lover, which proves to be just a small part in a bigger mystery.", released_on: "2023-02-28", director: "Bruce Wayne", duration: "120", image_file_name: "placeholder.png"},
  ])
